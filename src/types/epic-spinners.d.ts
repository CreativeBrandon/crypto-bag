declare module 'epic-spinners' {
    ...
    export class FlowerSpinner extends Vue {}
    export class FingerprintSpinner extends Vue {}
    ...
    export class PixelSpinner extends Vue {}
    export class RadarSpinner extends Vue {}
    export class ScalingSquaresSpinner extends Vue {}
    export class SelfBuildingSquareSpinner extends Vue {}
    export class SemipolarSpinner extends Vue {}
    export class SpringSpinner extends Vue {}
